  ...
  window.addEventListener('load', function(){
    ...
    panel.innerHTML = supported
      ? '<h4>ผูกอุปกรณ์ก่อนเริ่มใช้งาน</h4>' +
        '<p>เพื่อป้องกันการลงเวลาแทนกัน ระบบจะขอยืนยันตัวตนด้วย Face ID หรือลายนิ้วมือ ' +
        'ของเครื่องนี้ทุกครั้งที่เช็คอิน-เอาท์</p>' +
        '<button id="ttEnrollBtn">ผูกอุปกรณ์นี้</button>' +
        '<div class="err" id="ttEnrollErr"></div>'
      : '<h4>อุปกรณ์นี้ยังใช้ลงเวลาไม่ได้</h4>' +
        '<p>เบราว์เซอร์หรือเครื่องนี้ไม่รองรับการยืนยันตัวตนด้วยชีวมิติ ' +
        'กรุณาใช้มือถือที่ตั้ง Face ID / ลายนิ้วมือไว้ หรือแจ้งผู้ดูแลระบบเพื่อขอยกเว้น</p>';
