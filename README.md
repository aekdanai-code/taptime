...
**เวอร์ชันปัจจุบัน: 1.3.1** — สรุปทุกอย่างที่เปลี่ยนอยู่ใน [CHANGELOG.md](CHANGELOG.md)
...
│
├── docs/                         คู่มือการใช้งาน (HTML เปิดเดี่ยว ๆ ได้)
│   ├── manual-admin.html         คู่มือผู้ดูแลระบบ
│   └── manual-employee.html      คู่มือพนักงาน
│
...
- ค้นหาจาก ชื่อ / ชื่อเล่น / เบอร์โทร / อีเมล / ตำแหน่ง / สาขา / เลขบัตร
  (ค้นเจอแม้ข้อมูลนั้นจะไม่ได้แสดงในตาราง)
- กรองด้วย **สาขา · สถานะ · สิทธิ์** (กรองพร้อมกันได้)
...
**ตารางแสดงเฉพาะข้อมูลที่จำเป็น** — ลำดับ · ชื่อ · สาขา · สถานะ · บัญชีผู้ใช้ · จัดการ

| สิ่งที่ทำ | เหตุผล |
|---|---|
| ซ่อนอีเมล เบอร์โทร ตำแหน่ง ประเภทเงินเดือน | ลดความรก — ยังค้นหาเจอและแก้ได้ในฟอร์ม |
| เอาตัวกรองตำแหน่งออก | เหลือ สาขา / สถานะ / สิทธิ์ ที่ใช้จริงบ่อยกว่า |
| ปุ่มจัดการเป็นไอคอน (ซองจดหมาย · ดินสอ · ถังขยะ) | แถวสั้นลงมาก · เอาเมาส์ชี้จะขึ้นคำอธิบาย |
| ป้ายรูปโล่หลังชื่อ | เห็นทันทีว่าใครเป็น **แอดมิน** (ฟ้า) หรือ **หัวหน้างาน** (ส้ม) |
...
รันชุดทดสอบ **219 ข้อ** บนฐานข้อมูลจำลองในหน่วยความจำที่โหลด **ข้อมูลจริงจาก TapTime.xlsx**
