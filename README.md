...
**เวอร์ชันปัจจุบัน: 1.3.2** — สรุปทุกอย่างที่เปลี่ยนอยู่ใน [CHANGELOG.md](CHANGELOG.md)
...
รันชุดทดสอบ **228 ข้อ** บนฐานข้อมูลจำลองในหน่วยความจำที่โหลด **ข้อมูลจริงจาก TapTime.xlsx**
